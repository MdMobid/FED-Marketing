      ...
      if (!res.ok) {
        ...
        if (res.status === 403) {
          setToast({
            ...
            message:
              j.error ||
              'Your email is not on the administrator whitelist. Access has been denied.',
          });
          return;
        }
      ...
      if (!res.ok) {
        ...
        if (res.status === 403) {
          setToast({
            ...
            message:
              j.error ||
              'Your Google account is not on the administrator whitelist. Access has been denied and unapproved account purged.',
          });
          return;
        }
      ...
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl bg-[#121214] border border-[#27272a] p-6 sm:p-8 shadow-2xl">
          ...
          <div className="mb-6">
            ...
            <h1 className="text-xl sm:text-2xl font-bold text-white tracking-tight">Portal Sign In</h1>
            <p className="text-xs sm:text-sm text-zinc-400 mt-1">Access member attribution &amp; admin console</p>
          </div>
          ...
          <div className="mt-5 text-center text-xs sm:text-sm text-zinc-400">
            ...
            <Link href="/signup" className="text-[#ea580c] hover:underline font-semibold ml-1">
              Create one
            </Link>
          </div>
